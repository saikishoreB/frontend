...
<nav class="navbar navbar-light" style="background-color: #e2f556;">
  <div class="container-fluid">
    <div class="navbar-header"  style="background-color:#f1f3da;width:180px;margin-left:0">
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="<c:url value='/all/registerform'></c:url>"><span class="glyphicon glyphicon-user"></span> Register</a></li>
